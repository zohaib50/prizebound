        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                       <div class="p-3">
                           <form class="form" method="post" action="{{route('bound.year.store')}}">
                               @csrf
                               <div class="mb-3 row">
                                   <label for="inputPassword" class="col-sm-4 col-form-label text-end">Year:</label>
                                   <div class="col-sm-8">
                                       <input type="text" name="name" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" placeholder="Year">
                                       @error('name')
