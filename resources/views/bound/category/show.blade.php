                        ...
                        <div class="p-3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped w-100">
                                    ...
                                    <tbody>
                                    @foreach($category->years as $key => $year)
                                        <tr >
                                        <td class="p-2">{{$key+1}}</td>
                                        <td class="p-2">{{$year->name}}</td>
                                        <td class="p-2 text-end">
                                            <a href="{{route('bound.year.show', $year->id)}}" class="me-2 btn btn-sm btn-outline-success">
                                            ...
                                            <a href="{{route('bound.year.edit', $year->id)}}" class="me-2 btn btn-sm btn-outline-primary">
