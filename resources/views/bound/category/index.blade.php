                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="p-2 text-end">
                                            <a href="{{route('bound.category.show', 1)}}" class="me-2 btn btn-sm btn-outline-success">
                                            ...
                                            <a href="{{route('bound.category.edit', 1)}}" class="me-2 btn btn-sm btn-outline-primary">
                                            ...
                                            <button type="button" class="me-2 btn btn-sm btn-outline-danger">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
