        ...
        <table class="table table-striped w-100">
            ...
            <tr v-for="(item, index) in items">
                ...
                <td class="p-2 text-end">
                    <a :href="'/bound/category/'+item.id" class="me-2 btn btn-sm btn-outline-success">
                    ...
                    <a :href="'/bound/category/'+item.id+'/edit'" class="me-2 btn btn-sm btn-outline-primary">
...
export default {
    ...
    methods:{
        ...
        deleteData(id){
            axios.delete('/bound/api/category/'+id).then(response =>{
                this.getData()
            })
        }
    }
